...
select o.order_id, c.company_name, count(*)
...
## Pet Type Table
| Person ID | Pet Name | Pet Type | Pet Name 2 | Pet Type 2 | Pet Name 3 | Pet Type 3 |
|-----------|----------|----------|------------|------------|------------|------------|
| 1         | Ellie    | Dog      | Tiger      | Cat        | Toby       | Turtle     |
| 2         | Joe      | Horse    |            |            |            |            |
| 3         | Ginger   | Dog      | Miss Kitty | Cat        | Bubble     | Fish       |
